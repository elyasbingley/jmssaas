...
const PERSONAL_SETTINGS_ITEMS = [
  ...
  // UI Settings (accent/font size/font family) is also a personal device
  // preference, not a company setting - same "own profile row" reasoning
  // as Dashboard/Google Calendar above.
  { href: "/ui-settings", label: "UI Settings", emoji: "🎨" },
] as const;
