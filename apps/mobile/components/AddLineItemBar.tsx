...
const styles = StyleSheet.create({
  ...
  spinner: { marginTop: 8 },
  results: { borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 8, marginTop: 8, overflow: "hidden" },
  resultRow: { padding: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "#f0f0f0" },
  ...
  variationRow: { paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "#f0f0f0" },
