...
// Job-specific material order requisition PDF - same escape/company-block
// pattern as shopping-list-pdf.ts (that file's own header comment explains
// why this is duplicated per-app rather than shared).
