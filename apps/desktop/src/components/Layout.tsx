...
const navSections: { heading: string | null; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // (Company Details, Dashboard, Automation & Messaging, Job Setup, ...),
      // since they're all reached through the single Settings tile grid now
      // (see SettingsHub.tsx, which has its own Dashboard tile) rather than
      // each having their own nav link.
