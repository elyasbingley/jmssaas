...
export function PurchaseOrderNumberModal({
  ...
  return (
    <ThemedModal open={open} onClose={onClose} title="Purchase order number">
      <ThemedFormField label="PO number" value={value} onChange={(e) => setValue(e.target.value)} placeholder="e.g. PO-4821" />
      {error ? (
